		...
		function createGithubInboxStore(apiFace, service) {
			...
			return {
				...
				refresh: async () => {
					...
					inFlight = run.then(() => void 0, () => void 0).finally(() => {
						inFlight = null;
					});
					await run;
				},
		...
		*/
		...
		function ConfirmBar(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dgh-confirm",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dgh-confirmMsg",
						children: props.message
					}),
					props.draft === true && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
		...
		function ThreadRow(props) {
			...
			const confirmMessage = props.confirmKind === "approve" ? t("githubApproveConfirm") : props.confirmKind === "changes" ? t("githubChangesConfirm") : t("githubDoneConfirm");
			const confirmLabel = props.confirmKind === "approve" ? t("githubApprove") : props.confirmKind === "changes" ? t("githubRequestChanges") : t("githubMarkDone");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: cx("dgh-thread", "dgh-cat-" + category),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					onKeyDown: (event) => {
						if (event.key === "Enter") props.onToggle();
					},
					children: [
						props.selectMode && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
							className: "dgh-check",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [
									pr !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: "dgh-num",
										children: ["#", pr]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: cx("dgh-tag", "dgh-tag-" + category),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: cx("dgh-chevron", props.expanded && "dgh-chevronOpen"),
							children: "▸"
						})
					]
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dgh-actions",
							children: [isPullRequest && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									className: "dgh-action dgh-actionApprove",
								...
								className: "dgh-action",
								disabled: busy || readonly,
								onClick: props.onSecondaryToggle,
								children: [
									t("githubMore"),
									" ",
									props.secondaryOpen ? "▴" : "▾"
						...
						props.secondaryOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: "dgh-actions",
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									className: "dgh-action",
						...
						props.confirmKind !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConfirmBar, {
						...
						pr !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
								...
								className: "dgh-action",
								disabled: busy || readonly || props.commentDraft.trim() === "",
								...
								props.mergeStatus !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											props.mergeStatus.mergeable === null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "dgh-mergeMeta",
												children: t("githubMergePending")
											}),
											props.mergeStatus.checks.some((check) => check.status === "in_progress") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "dgh-mergeMeta",
												children: t("githubMergeRunning")
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												className: "dgh-action",
												disabled: props.mergeLoading || readonly,
												onClick: props.onMergeRefresh,
												children: t("githubRefresh")
											})
										]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									props.mergeStatus.mergeable === true && props.mergeStatus.state === "open" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		function InboxView(props) {
			...
			const [confirmKind, setConfirmKind] = (0, react.useState)(null);
			const [confirmDraft, setConfirmDraft] = (0, react.useState)("");
			...
			const [visibleThreads, setVisibleThreads] = (0, react.useState)([]);
			const visibleRef = (0, react.useRef)([]);
			...
			const markManyRead = async (items) => {
			...
			const submitReview = async (thread, event, body) => {
				const pr = threadNumber(thread.url);
				if (pr === void 0) return;
			...
			const confirmSubmit = (thread) => {
				if (confirmKind === "done") markDone(thread);
				else if (confirmKind === "approve") submitReview(thread, "APPROVE", confirmDraft.trim() === "" ? void 0 : confirmDraft.trim());
				else if (confirmKind === "changes") submitReview(thread, "REQUEST_CHANGES", confirmDraft.trim());
			};
			const openMerge = (thread) => {
				...
				fetchMergeStatus(thread, pr);
			};
			const fetchMergeStatus = async (thread, pr) => {
				try {
			...
			const toggleChip = (category) => {
				...
				setActionError(null);
				callSidebarSettings({ pluginSettings: { [SETTINGS_KEY]: { [key]: next } } }).catch(() => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					confirmKind === "allRead" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConfirmBar, {
					...
					selectMode && selected.size > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dgh-bulkbar",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("githubBulkSelected", { count: selected.size }) }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								className: "dgh-action",
								disabled: busy !== null || readonly,
								onClick: () => {
									markManyRead(threads.filter((thread) => selected.has(thread.id)));
								},
								children: t("githubMarkRead")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: t("githubClearSelection")
							})
						]
					}),
					pendingNew > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						className: "dgh-newbar",
						onClick: applyPending,
						children: t("githubNewNotifications", { count: pendingNew })
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dgh-chips",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dgh-groupName",
										children: group.repo
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dgh-groupCount",
										children: countUnread(group.threads)
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										className: "dgh-groupRead",
										disabled: busy !== null || readonly || group.threads.length === 0,
										title: t("githubRepoMarkRead"),
										onClick: () => {
											markManyRead(group.threads);
										},
										children: "✓"
									})
								]

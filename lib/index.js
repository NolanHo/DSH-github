...
const name = "dsh-github-inbox";
/** The route prefix the client half posts to. */
const API_PREFIX = "/plugins/dsh-github-inbox/api";
/**
* Plugin body.
	...
	ctx.inject(["webServer", "webRuntime"], (sctx) => {
		sctx.effect(() => sctx.webServer.register({
			...
			handler: async (req, res) => {
				...
				const method = pathname.startsWith("/plugins/dsh-github-inbox/api/") ? pathname.slice(30) : void 0;

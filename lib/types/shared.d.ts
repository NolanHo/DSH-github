...
export type GithubWireErrorCode = 'bad-request' | 'not-found' | 'forbidden' | 'method-error' | 'github-auth' | 'github-not-found' | 'github-rejected' | 'github-forbidden' | 'github-unavailable' | 'github-error' | 'internal';
...
export declare const GITHUB_POLL_SECONDS_MIN = 60;
export declare const GITHUB_POLL_SECONDS_MAX = 300;
export declare const GITHUB_POLL_SECONDS_DEFAULT = 60;
